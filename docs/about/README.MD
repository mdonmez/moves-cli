...
- **[Test System](tests.md):** The documentation describes a test package covering critical CLI workflows, core business logic, data processing components, and auxiliary functions.

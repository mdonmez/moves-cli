...
- **[Test System](tests.md):** The documentation describes a test package consisting of 48 tests covering critical CLI workflows, core business logic, data processing components, and auxiliary functions.

...
If you want a deeper look into moves, the [About](about/README.MD) documents covers its internal architecture, execution flow, operation logic, tests and design decisions behind mechanisms.
